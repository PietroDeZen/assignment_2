...
// let  Thin, Regular, Medium, Bold, Black;

// function preload() {
//   Thin = loadFont('PublicSans-Thin.ttf');
//   Regular = loadFont('PublicSans-Regular.ttf');
//   Medium = loadFont('PublicSans-Medium.ttf');
//   Bold = loadFont('PublicSans-Bold.ttf');
//   Black = loadFont('PublicSans-Black.ttf');
// }
